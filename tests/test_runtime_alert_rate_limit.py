...
def test_rate_limit_enforces_per_automation_daily_cap() -> None:
...
def test_rate_limit_enforces_global_daily_cap() -> None:
...
def test_rate_limit_counters_reset_on_new_day() -> None:
