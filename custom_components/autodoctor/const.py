...
DEFAULT_RUNTIME_HEALTH_ANOMALY_THRESHOLD = 1.3
...
DEFAULT_RUNTIME_EVENT_STORE_ENABLED = False
DEFAULT_RUNTIME_EVENT_STORE_SHADOW_READ = False
DEFAULT_RUNTIME_EVENT_STORE_CUTOVER = False
DEFAULT_RUNTIME_EVENT_STORE_RECONCILIATION_ENABLED = False
DEFAULT_RUNTIME_SCHEDULE_ANOMALY_ENABLED = False
DEFAULT_RUNTIME_DAILY_ROLLUP_ENABLED = False
...
CONF_RUNTIME_EVENT_STORE_ENABLED = "runtime_event_store_enabled"
CONF_RUNTIME_EVENT_STORE_SHADOW_READ = "runtime_event_store_shadow_read"
CONF_RUNTIME_EVENT_STORE_CUTOVER = "runtime_event_store_cutover"
CONF_RUNTIME_EVENT_STORE_RECONCILIATION_ENABLED = (
    "runtime_event_store_reconciliation_enabled"
)
CONF_RUNTIME_SCHEDULE_ANOMALY_ENABLED = "runtime_schedule_anomaly_enabled"
CONF_RUNTIME_DAILY_ROLLUP_ENABLED = "runtime_daily_rollup_enabled"
