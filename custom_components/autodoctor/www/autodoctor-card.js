...
`;let bt=class extends nt{constructor(){super(...arguments),this.dismissedKeys=new Set}render(){const t=this.group;return q`
      ...
      <ha-card>
        ...
        <div class="card-content">
          ...
          ${"suppressions"===this._view?q`<autodoc-suppressions
              ...
              ></autodoc-suppressions>`:r?s.map(t=>q`
                    <autodoc-issue-group
                      .group=${t}
                    ...
                    ></autodoc-issue-group>
                  `):o?this._renderAllHealthy(i.healthy):this._renderFirstRun()}
        </div>
        ${this._renderFooter()}
      </ha-card>
    ...
    `}_renderBadges(t){return function(t,e,s){return q`
    <div class="badges-row">
      ...
      ${t.healthy>0?q`<span class="badge badge-healthy" title="${t.healthy} healthy">
            <span class="badge-icon" aria-hidden="true">\u2713</span>
            <span class="badge-count">${t.healthy}</span>
          </span>`:W}
      ${t.suppressed>0?q`<span
            class="badge badge-suppressed ${"suppressions"===s?"badge-active":""}"
            title="${t.suppressed} suppressed"
            role="button"
            tabindex="0"
            @click=${()=>e?.("suppressions")}
            @keydown=${t=>{"Enter"!==t.key&&" "!==t.key||(t.preventDefault(),e?.("suppressions"))}}
  ...
  `}(t,t=>{this._view=t},this._view)}_renderFooter(){const t=this._runningValidation||this._loading,e=t||Date.now()-this._lastValidationClick<wt.CLICK_COOLDOWN_MS;return q`
    ...
    `}};t([ut({attribute:!1})],St.prototype,"hass",void 0),t([ht()],St.prototype,"_config",void 0),St=t([ct("autodoctor-card-editor")],St);var Et=Object.freeze({__proto__:null,get AutodoctorCardEditor(){return St}});export{At as AutodoctorCard};
