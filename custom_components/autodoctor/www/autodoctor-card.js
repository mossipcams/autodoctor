 ...
 */
class AutodocIssueGroup extends i {
    constructor() {
        super(...arguments);
...
class AutodocPipeline extends i {
    constructor() {
        super(...arguments);
        this.groups = [];
        this.running = false;
...
class AutodocSuppressions extends i {
    constructor() {
        super(...arguments);
        this._suppressions = [];
        this._loading = true;
...
AutodocSuppressions.properties = {
...
class AutodoctorCardEditor extends i {
    setConfig(config) {
        this._config = config;
    }
    _valueChanged(ev) {
...
AutodoctorCardEditor.properties = {
    hass: { attribute: false },
    _config: { state: true },
};
...
var autodoctorCardEditor = /*#__PURE__*/Object.freeze({
    __proto__: null,
    AutodoctorCardEditor: AutodoctorCardEditor
});
