 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w=globalThis,A=t=>t,C=w.trustedTypes,S=C?C.createPolicy("lit-html",{createHTML:t=>t}):void 0,E="$lit$",k=`lit$${Math.random().toFixed(9).slice(2)}$`,z="?"+k,T=`<${z}>`,P=document,O=()=>P.createComment(""),R=t=>null===t||"object"!=typeof t&&"function"!=typeof t,I=Array.isArray,U="[ \t\n\f\r]",D=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,H=/-->/g,M=/>/g,N=RegExp(`>|${U}(?:([^\\s"'>=/]+)(${U}*=${U}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),V=/'/g,j=/"/g,L=/^(?:script|style|textarea|title)$/i,q=(t=>(e,...s)=>({_$litType$:t,strings:e,values:s}))(1),B=Symbol.for("lit-noChange"),W=Symbol.for("lit-nothing"),F=new WeakMap,K=P.createTreeWalker(P,129);function G(t,e){if(!I(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==S?S.createHTML(e):e}const J=(t,e)=>{const s=t.length-1,i=[];let o,a=2===e?"<svg>":3===e?"<math>":"",r=D;for(let e=0;e<s;e++){const s=t[e];let n,c,d=-1,l=0;for(;l<s.length&&(r.lastIndex=l,c=r.exec(s),null!==c);)l=r.lastIndex,r===D?"!--"===c[1]?r=H:void 0!==c[1]?r=M:void 0!==c[2]?(L.test(c[2])&&(o=RegExp("</"+c[2],"g")),r=N):void 0!==c[3]&&(r=N):r===N?">"===c[0]?(r=o??D,d=-1):void 0===c[1]?d=-2:(d=r.lastIndex-c[2].length,n=c[1],r=void 0===c[3]?N:'"'===c[3]?j:V):r===j||r===V?r=N:r===H||r===M?r=D:(r=N,o=void 0);const u=r===N&&t[e+1].startsWith("/>")?" ":"";a+=r===D?s+T:d>=0?(i.push(n),s.slice(0,d)+E+s.slice(d)+k+u):s+k+(-2===d?e:u)}return[G(t,a+(t[s]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),i]};class Y{constructor({strings:t,_$litType$:e},s){let i;this.parts=[];let o=0,a=0;const r=t.length-1,n=this.parts,[c,d]=J(t,e);if(this.el=Y.createElement(c,s),K.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(i=K.nextNode())&&n.length<r;){if(1===i.nodeType){if(i.hasAttributes())for(const t of i.getAttributeNames())if(t.endsWith(E)){const e=d[a++],s=i.getAttribute(t).split(k),r=/([.?@])?(.*)/.exec(e);n.push({type:1,index:o,name:r[2],strings:s,ctor:"."===r[1]?et:"?"===r[1]?st:"@"===r[1]?it:tt}),i.removeAttribute(t)}else t.startsWith(k)&&(n.push({type:6,index:o}),i.removeAttribute(t));if(L.test(i.tagName)){const t=i.textContent.split(k),e=t.length-1;if(e>0){i.textContent=C?C.emptyScript:"";for(let s=0;s<e;s++)i.append(t[s],O()),K.nextNode(),n.push({type:2,index:++o});i.append(t[e],O())}}}else if(8===i.nodeType)if(i.data===z)n.push({type:2,index:o});else{let t=-1;for(;-1!==(t=i.data.indexOf(k,t+1));)n.push({type:7,index:o}),t+=k.length-1}o++}}static createElement(t,e){const s=P.createElement("template");return s.innerHTML=t,s}}function Z(t,e,s=t,i){if(e===B)return e;let o=void 0!==i?s._$Co?.[i]:s._$Cl;const a=R(e)?void 0:e._$litDirective$;return o?.constructor!==a&&(o?._$AO?.(!1),void 0===a?o=void 0:(o=new a(t),o._$AT(t,s,i)),void 0!==i?(s._$Co??=[])[i]=o:s._$Cl=o),void 0!==o&&(e=Z(t,o._$AS(t,e.values),o,i)),e}class X{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:s}=this._$AD,i=(t?.creationScope??P).importNode(e,!0);K.currentNode=i;let o=K.nextNode(),a=0,r=0,n=s[0];for(;void 0!==n;){if(a===n.index){let e;2===n.type?e=new Q(o,o.nextSibling,this,t):1===n.type?e=new n.ctor(o,n.name,n.strings,this,t):6===n.type&&(e=new ot(o,this,t)),this._$AV.push(e),n=s[++r]}a!==n?.index&&(o=K.nextNode(),a++)}return K.currentNode=P,i}p(t){let e=0;for(const s of this._$AV)void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}}class Q{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,s,i){this.type=2,this._$AH=W,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=Z(this,t,e),R(t)?t===W||null==t||""===t?(this._$AH!==W&&this._$AR(),this._$AH=W):t!==this._$AH&&t!==B&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>I(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==W&&R(this._$AH)?this._$AA.nextSibling.data=t:this.T(P.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:s}=t,i="number"==typeof s?this._$AC(t):(void 0===s.el&&(s.el=Y.createElement(G(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===i)this._$AH.p(e);else{const t=new X(i,this),s=t.u(this.options);t.p(e),this.T(s),this._$AH=t}}_$AC(t){let e=F.get(t.strings);return void 0===e&&F.set(t.strings,e=new Y(t)),e}k(t){I(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,i=0;for(const o of t)i===e.length?e.push(s=new Q(this.O(O()),this.O(O()),this,this.options)):s=e[i],s._$AI(o),i++;i<e.length&&(this._$AR(s&&s._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=A(t).nextSibling;A(t).remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class tt{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,i,o){this.type=1,this._$AH=W,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=o,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=W}_$AI(t,e=this,s,i){const o=this.strings;let a=!1;if(void 0===o)t=Z(this,t,e,0),a=!R(t)||t!==this._$AH&&t!==B,a&&(this._$AH=t);else{const i=t;let r,n;for(t=o[0],r=0;r<o.length-1;r++)n=Z(this,i[s+r],e,r),n===B&&(n=this._$AH[r]),a||=!R(n)||n!==this._$AH[r],n===W?t=W:t!==W&&(t+=(n??"")+o[r+1]),this._$AH[r]=n}a&&!i&&this.j(t)}j(t){t===W?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class et extends tt{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===W?void 0:t}}class st extends tt{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==W)}}class it extends tt{constructor(t,e,s,i,o){super(t,e,s,i,o),this.type=5}_$AI(t,e=this){if((t=Z(this,t,e,0)??W)===B)return;const s=this._$AH,i=t===W&&s!==W||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,o=t!==W&&(s===W||i);i&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class ot{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){Z(this,t)}}const at=w.litHtmlPolyfillSupport;at?.(Y,Q),(w.litHtmlVersions??=[]).push("3.3.2");const rt=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */function pt(t){return ht({...t,state:!0,attribute:!1})}var gt;console.info("%c AUTODOCTOR-CARD %c 2.1.0 ","color: white; background: #3498db; font-weight: bold;","color: #3498db; background: white; font-weight: bold;");let ft=gt=class extends nt{constructor(){super(...arguments),this._loadingValidation=!0,this._loadingConflicts=!1,this._error=null,this._activeTab="validation",this._validationData=null,this._conflictsData=null,this._runningValidation=!1,this._runningConflicts=!1,this._dismissedSuggestions=new Set,this._validationRequestId=0,this._conflictsRequestId=0,this._suppressionInProgress=!1,this._lastValidationClick=0,this._lastConflictsClick=0}_isInCooldown(t){const e=t?this._lastValidationClick:this._lastConflictsClick;return Date.now()-e<gt.CLICK_COOLDOWN_MS}setConfig(t){this.config=t}static getStubConfig(){return{type:"custom:autodoctor-card"}}static async getConfigElement(){return await Promise.resolve().then(function(){return mt}),document.createElement("autodoctor-card-editor")}async firstUpdated(){await this._fetchValidation()}_switchTab(t){this._activeTab=t,"validation"!==t||this._validationData||this._loadingValidation?"conflicts"!==t||this._conflictsData||this._loadingConflicts||this._fetchConflicts():this._fetchValidation()}async _fetchValidation(){const t=++this._validationRequestId;this._loadingValidation=!0;try{this._error=null;const e=await this.hass.callWS({type:"autodoctor/validation"});t===this._validationRequestId&&(this._validationData=e)}catch(e){t===this._validationRequestId&&(console.error("Failed to fetch validation data:",e),this._error="Failed to load validation data")}t===this._validationRequestId&&(this._loadingValidation=!1)}async _runValidation(){const t=Date.now();if(this._runningValidation||t-this._lastValidationClick<gt.CLICK_COOLDOWN_MS)return;this._lastValidationClick=t;const e=++this._validationRequestId;this._runningValidation=!0;try{const t=await this.hass.callWS({type:"autodoctor/validation/run"});e===this._validationRequestId&&(this._validationData=t)}catch(t){e===this._validationRequestId&&console.error("Failed to run validation:",t)}e===this._validationRequestId&&(this._runningValidation=!1)}async _fetchConflicts(){const t=++this._conflictsRequestId;this._loadingConflicts=!0;try{this._error=null;const e=await this.hass.callWS({type:"autodoctor/conflicts"});t===this._conflictsRequestId&&(this._conflictsData=e)}catch(e){t===this._conflictsRequestId&&(console.error("Failed to fetch conflicts data:",e),this._error="Failed to load conflicts data")}t===this._conflictsRequestId&&(this._loadingConflicts=!1)}async _runConflicts(){const t=Date.now();if(this._runningConflicts||t-this._lastConflictsClick<gt.CLICK_COOLDOWN_MS)return;this._lastConflictsClick=t;const e=++this._conflictsRequestId;this._runningConflicts=!0;try{const t=await this.hass.callWS({type:"autodoctor/conflicts/run"});e===this._conflictsRequestId&&(this._conflictsData=t)}catch(t){e===this._conflictsRequestId&&console.error("Failed to run conflict detection:",t)}e===this._conflictsRequestId&&(this._runningConflicts=!1)}_groupIssuesByAutomation(t){const e=new Map;for(const s of t){const{issue:t,edit_url:i}=s,o=t.automation_id;e.has(o)||e.set(o,{automation_id:t.automation_id,automation_name:t.automation_name,issues:[],edit_url:i,has_error:!1,error_count:0,warning_count:0});const a=e.get(o);a.issues.push(s),"error"===t.severity?(a.has_error=!0,a.error_count++):a.warning_count++}return Array.from(e.values())}_getCounts(t){if(!t)return{errors:0,warnings:0,healthy:0,suppressed:0};let e=0,s=0;for(const i of t.issues)"error"===i.issue.severity?e++:s++;return{errors:e,warnings:s,healthy:t.healthy_count,suppressed:t.suppressed_count||0}}get _loading(){return"validation"===this._activeTab?this._loadingValidation:this._loadingConflicts}render(){const t=this.config.title||"Autodoctor";if(this._loading)return this._renderLoading(t);if(this._error)return this._renderError(t);if("conflicts"===this._activeTab)return this._renderConflictsTab(t);const e=this._validationData;if(!e)return this._renderEmpty(t);const s=this._groupIssuesByAutomation(e.issues),i=this._getCounts(e),o=e.issues.length>0;return q`
    ...
    `}_renderError(t){return q`
      <ha-card>
        ...
        <div class="card-content error-state">
          ...
          <button class="retry-btn" @click=${()=>"validation"===this._activeTab?this._fetchValidation():this._fetchConflicts()}>
            Try again
          </button>
        </div>
      </ha-card>
    ...
    `}_renderTabFooter(){const t="validation"===this._activeTab,e=t?this._runningValidation:this._runningConflicts,s=t?this._loadingValidation:this._loadingConflicts,i=e||s||this._isInCooldown(t),o=t?this._validationData?.last_run:this._conflictsData?.last_run,a=e||s;return q`
      <div class="footer">
        <button
    ...
    `}};t([ht({attribute:!1})],vt.prototype,"hass",void 0),t([pt()],vt.prototype,"_config",void 0),vt=t([dt("autodoctor-card-editor")],vt);var mt=Object.freeze({__proto__:null,get AutodoctorCardEditor(){return vt}});export{ft as AutodoctorCard};
