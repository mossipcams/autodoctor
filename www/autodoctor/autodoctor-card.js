function t(t, e, s, i) {
  var o,
    a = arguments.length,
    r = a < 3 ? e : null === i ? (i = Object.getOwnPropertyDescriptor(e, s)) : i;
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate)
    r = Reflect.decorate(t, e, s, i);
  else
    for (var n = t.length - 1; n >= 0; n--)
      (o = t[n]) && (r = (a < 3 ? o(r) : a > 3 ? o(e, s, r) : o(e, s)) || r);
  return (a > 3 && r && Object.defineProperty(e, s, r), r);
}
...
let a = class {
  ...
  get styleSheet() {
    ...
    if (s && void 0 === t) {
      ...
      (s && (t = o.get(e)),
        void 0 === t &&
          ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), s && o.set(e, t)));
    }
    return t;
  }
  toString() {
...
const r = (t, ...e) => {
  ...
  f = g.trustedTypes,
  v = f ? f.emptyScript : "",
  m = g.reactiveElementPolyfillSupport,
  _ = (t, e) => t,
  b = {
    toAttribute(t, e) {
      switch (e) {
  ...
  y = (t, e) => !c(t, e),
  $ = { attribute: !0, type: String, converter: b, reflect: !1, useDefault: !1, hasChanged: y };
/**
 * @license
...
let x = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, e, s) {
    const { get: i, set: o } = l(this.prototype, t) ?? {
      get() {
        return this[e];
      },
      set(t) {
    ...
    return {
      ...
      set(e) {
        const a = i?.call(this);
        (o?.call(this, e), this.requestUpdate(t, a, s));
      },
      configurable: !0,
      enumerable: !0,
    };
  ...
  createRenderRoot() {
    ...
    return (
      ((t, i) => {
        if (s) t.adoptedStyleSheets = i.map((t) => (t instanceof CSSStyleSheet ? t : t.styleSheet));
        else
          for (const s of i) {
  ...
  _$ET(t, e) {
    ...
    if (void 0 !== i && !0 === s.reflect) {
      const o = (void 0 !== s.converter?.toAttribute ? s.converter : b).toAttribute(e, s.type);
      ((this._$Em = t),
        ...
        o =
          "function" == typeof t.converter
            ...
            : void 0 !== t.converter?.fromAttribute
              ...
              : b;
      this._$Em = i;
      const a = o.fromAttribute(e, t.type);
  ...
  requestUpdate(t, e, s, i = !1, o) {
    if (void 0 !== t) {
      ...
      if (
        (!1 === i && (o = this[t]),
        (s ??= a.getPropertyOptions(t)),
        !(
          (s.hasChanged ?? y)(o, e) ||
          (s.useDefault && s.reflect && o === this._$Ej?.get(t) && !this.hasAttribute(a._$Eu(t, s)))
        ))
      )
        return;
      this.C(t, e, s);
  ...
  C(t, e, { useDefault: s, reflect: i, wrapped: o }, a) {
    (s &&
      ...
      (this._$Ej.set(t, a ?? e ?? this[t]), !0 !== o || void 0 !== a)) ||
...
const w = globalThis,
  A = (t) => t,
  C = w.trustedTypes,
  S = C ? C.createPolicy("lit-html", { createHTML: (t) => t }) : void 0,
  E = "$lit$",
  ...
  F = new WeakMap(),
  K = P.createTreeWalker(P, 129);
function G(t, e) {
  if (!I(t) || !t.hasOwnProperty("raw")) throw Error("invalid template strings array");
...
const J = (t, e) => {
  ...
  for (let e = 0; e < s; e++) {
    ...
    let n,
      ...
      d = -1,
      l = 0;
    for (; l < s.length && ((r.lastIndex = l), (c = r.exec(s)), null !== c); )
      ((l = r.lastIndex),
        r === D
          ? "!--" === c[1]
            ? (r = H)
          ...
          : r === N
            ? ">" === c[0]
              ...
              : void 0 === c[1]
                ? (d = -2)
                : ((d = r.lastIndex - c[2].length),
                  (n = c[1]),
                  (r = void 0 === c[3] ? N : '"' === c[3] ? j : V))
            : r === j || r === V
              ? (r = N)
              : r === H || r === M
                ? (r = D)
                : ((r = N), (o = void 0)));
    const u = r === N && t[e + 1].startsWith("/>") ? " " : "";
    a +=
      r === D
        ? s + T
        : d >= 0
          ? (i.push(n), s.slice(0, d) + E + s.slice(d) + k + u)
          : s + k + (-2 === d ? e : u);
  }
  return [G(t, a + (t[s] || "<?>") + (2 === e ? "</svg>" : 3 === e ? "</math>" : "")), i];
};
class Y {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    const r = t.length - 1,
      ...
      [c, d] = J(t, e);
    if (
      ((this.el = Y.createElement(c, s)), (K.currentNode = this.el.content), 2 === e || 3 === e)
    ) {
      const t = this.el.content.firstChild;
      t.replaceWith(...t.childNodes);
    }
    for (; null !== (i = K.nextNode()) && n.length < r; ) {
      if (1 === i.nodeType) {
        if (i.hasAttributes())
          for (const t of i.getAttributeNames())
            if (t.endsWith(E)) {
              ...
              (n.push({
                ...
                name: r[2],
                strings: s,
                ctor: "." === r[1] ? et : "?" === r[1] ? st : "@" === r[1] ? it : tt,
              }),
                i.removeAttribute(t));
            } else t.startsWith(k) && (n.push({ type: 6, index: o }), i.removeAttribute(t));
        if (L.test(i.tagName)) {
          ...
          if (e > 0) {
            ...
            for (let s = 0; s < e; s++)
              (i.append(t[s], O()), K.nextNode(), n.push({ type: 2, index: ++o }));
            i.append(t[e], O());
          }
        }
      } else if (8 === i.nodeType)
        if (i.data === z) n.push({ type: 2, index: o });
        else {
          let t = -1;
          for (; -1 !== (t = i.data.indexOf(k, t + 1)); )
            (n.push({ type: 7, index: o }), (t += k.length - 1));
        }
      o++;
    }
  }
...
function Z(t, e, s = t, i) {
  ...
  return (
    o?.constructor !== a &&
      (o?._$AO?.(!1),
      void 0 === a ? (o = void 0) : ((o = new a(t)), o._$AT(t, s, i)),
      void 0 !== i ? ((s._$Co ??= [])[i] = o) : (s._$Cl = o)),
    void 0 !== o && (e = Z(t, o._$AS(t, e.values), o, i)),
    e
  );
}
class X {
  ...
  u(t) {
    const {
      ...
      i = (t?.creationScope ?? P).importNode(e, !0);
    K.currentNode = i;
    let o = K.nextNode(),
      a = 0,
      r = 0,
    ...
    for (; void 0 !== n; ) {
      if (a === n.index) {
        ...
        (2 === n.type
          ...
          : 1 === n.type
            ? (e = new n.ctor(o, n.name, n.strings, this, t))
            : 6 === n.type && (e = new ot(o, this, t)),
          this._$AV.push(e),
          (n = s[++r]));
      }
...
class Q {
  ...
  $(t) {
    const { values: e, _$litType$: s } = t,
      i =
        "number" == typeof s
          ? this._$AC(t)
          : (void 0 === s.el && (s.el = Y.createElement(G(s.h, s.h[0]), this.options)), s);
  ...
  k(t) {
    ...
    for (const o of t)
      (i === e.length
        ? e.push((s = new Q(this.O(O()), this.O(O()), this, this.options)))
        : (s = e[i]),
        s._$AI(o),
        i++);
...
class tt {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let a = !1;
    if (void 0 === o)
      ((t = Z(this, t, e, 0)), (a = !R(t) || (t !== this._$AH && t !== B)), a && (this._$AH = t));
    else {
      const i = t;
      let r, n;
...
const at = w.litHtmlPolyfillSupport;
(at?.(Y, Q), (w.litHtmlVersions ??= []).push("3.3.2"));
const rt = globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
    ...
    (this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
      ...
      (this._$Do = ((t, e, s) => {
        ...
        if (void 0 === o) {
          ...
          i._$litPart$ = o = new Q(e.insertBefore(O(), t), t, void 0, s ?? {});
        }
        return (o._$AI(t), o);
...
((nt._$litElement$ = !0), (nt.finalized = !0), rt.litElementHydrateSupport?.({ LitElement: nt }));
const ct = rt.litElementPolyfillSupport;
...
const dt = (t) => (e, s) => {
  ...
  ut = (t = lt, e, s) => {
    ...
    if (
      ...
      return {
        set(s) {
          ...
          (e.set.call(this, s), this.requestUpdate(i, o, t, !0, s));
        },
        init(e) {
    ...
    if ("setter" === i) {
      ...
      return function (s) {
        const o = this[i];
        (e.call(this, s), this.requestUpdate(i, o, t, !0, s));
      };
    }
...
var gt;
console.info(
  "%c AUTODOCTOR-CARD %c 2.1.0 ",
  "color: white; background: #3498db; font-weight: bold;",
  "color: #3498db; background: white; font-weight: bold;"
);
let ft = (gt = class extends nt {
  constructor() {
    (super(...arguments),
      (this._loadingValidation = !0),
      (this._loadingConflicts = !1),
      (this._error = null),
      (this._activeTab = "validation"),
      (this._validationData = null),
      (this._conflictsData = null),
      (this._runningValidation = !1),
      (this._runningConflicts = !1),
      (this._dismissedSuggestions = new Set()),
      (this._validationRequestId = 0),
      (this._conflictsRequestId = 0),
      (this._suppressionInProgress = !1),
      (this._lastValidationClick = 0),
      (this._lastConflictsClick = 0));
  }
  _isInCooldown(t) {
    const e = t ? this._lastValidationClick : this._lastConflictsClick;
    return Date.now() - e < gt.CLICK_COOLDOWN_MS;
  }
  setConfig(t) {
    this.config = t;
  }
  static getStubConfig() {
    return { type: "custom:autodoctor-card" };
  }
  static async getConfigElement() {
    return (
      ...
      document.createElement("autodoctor-card-editor")
    );
  }
  async firstUpdated() {
  ...
  _switchTab(t) {
    ((this._activeTab = t),
      "validation" !== t || this._validationData || this._loadingValidation
        ? "conflicts" !== t ||
          this._conflictsData ||
  ...
  async _fetchValidation() {
    const t = ++this._validationRequestId;
    this._loadingValidation = !0;
    try {
      this._error = null;
      const e = await this.hass.callWS({ type: "autodoctor/validation" });
      t === this._validationRequestId && (this._validationData = e);
    } catch (e) {
      t === this._validationRequestId &&
        (console.error("Failed to fetch validation data:", e),
        (this._error = "Failed to load validation data"));
    }
    t === this._validationRequestId && (this._loadingValidation = !1);
  }
  async _runValidation() {
    const t = Date.now();
    if (this._runningValidation || t - this._lastValidationClick < gt.CLICK_COOLDOWN_MS) return;
    this._lastValidationClick = t;
    const e = ++this._validationRequestId;
    this._runningValidation = !0;
    try {
      const t = await this.hass.callWS({ type: "autodoctor/validation/run" });
      e === this._validationRequestId && (this._validationData = t);
    } catch (t) {
      e === this._validationRequestId && console.error("Failed to run validation:", t);
    }
    e === this._validationRequestId && (this._runningValidation = !1);
  }
  async _fetchConflicts() {
    const t = ++this._conflictsRequestId;
    this._loadingConflicts = !0;
    try {
      this._error = null;
      const e = await this.hass.callWS({ type: "autodoctor/conflicts" });
      t === this._conflictsRequestId && (this._conflictsData = e);
    } catch (e) {
      t === this._conflictsRequestId &&
        (console.error("Failed to fetch conflicts data:", e),
        (this._error = "Failed to load conflicts data"));
    }
    t === this._conflictsRequestId && (this._loadingConflicts = !1);
  }
  async _runConflicts() {
    const t = Date.now();
    if (this._runningConflicts || t - this._lastConflictsClick < gt.CLICK_COOLDOWN_MS) return;
    this._lastConflictsClick = t;
    const e = ++this._conflictsRequestId;
    this._runningConflicts = !0;
    try {
      const t = await this.hass.callWS({ type: "autodoctor/conflicts/run" });
      e === this._conflictsRequestId && (this._conflictsData = t);
    } catch (t) {
      e === this._conflictsRequestId && console.error("Failed to run conflict detection:", t);
    }
    e === this._conflictsRequestId && (this._runningConflicts = !1);
  }
  _groupIssuesByAutomation(t) {
    const e = new Map();
    for (const s of t) {
      const { issue: t, edit_url: i } = s,
        o = t.automation_id;
      e.has(o) ||
        e.set(o, {
      ...
      const a = e.get(o);
      (a.issues.push(s),
        "error" === t.severity ? ((a.has_error = !0), a.error_count++) : a.warning_count++);
    }
    return Array.from(e.values());
  }
  _getCounts(t) {
    if (!t) return { errors: 0, warnings: 0, healthy: 0, suppressed: 0 };
    let e = 0,
      s = 0;
    for (const i of t.issues) "error" === i.issue.severity ? e++ : s++;
    return {
      errors: e,
      warnings: s,
      healthy: t.healthy_count,
      suppressed: t.suppressed_count || 0,
    };
  }
  get _loading() {
    return "validation" === this._activeTab ? this._loadingValidation : this._loadingConflicts;
  }
  render() {
    const t = this.config.title || "Autodoctor";
    if (this._loading) return this._renderLoading(t);
    if (this._error) return this._renderError(t);
    if ("conflicts" === this._activeTab) return this._renderConflictsTab(t);
    const e = this._validationData;
    if (!e) return this._renderEmpty(t);
    const s = this._groupIssuesByAutomation(e.issues),
      i = this._getCounts(e),
      o = e.issues.length > 0;
    return q`
      <ha-card>
  ...
  _renderBadges(t) {
    return q`
      <div class="badges-row">
        ${
          t.errors > 0
            ? q`<span class="badge badge-error" title="${t.errors} error${1 !== t.errors ? "s" : ""}">
        ...
        ${
          t.warnings > 0
            ? q`<span class="badge badge-warning" title="${t.warnings} warning${1 !== t.warnings ? "s" : ""}">
              <span class="badge-icon" aria-hidden="true">!</span>
        ...
        ${
          t.suppressed > 0
            ? q`<span class="badge badge-suppressed" title="${t.suppressed} suppressed">
              <span class="badge-icon" aria-hidden="true">⊘</span>
  ...
  _renderTabFooter() {
    const t = "validation" === this._activeTab,
      e = t ? this._runningValidation : this._runningConflicts,
      s = t ? this._loadingValidation : this._loadingConflicts,
      i = e || s || this._isInCooldown(t),
      o = t ? this._validationData?.last_run : this._conflictsData?.last_run,
      a = e || s;
    return q`
      <div class="footer">
        <button
          ...
          @click=${() => {
            t ? this._runValidation() : this._runConflicts();
          }}
          ?disabled=${i}
        >
  ...
  _getSuggestionKey(t) {
    return `${t.automation_id}:${t.entity_id}:${t.message}`;
  }
  _dismissSuggestion(t) {
    const e = this._getSuggestionKey(t);
    this._dismissedSuggestions = new Set([...this._dismissedSuggestions, e]);
  }
  async _suppressIssue(t) {
    if (!this._suppressionInProgress) {
      this._suppressionInProgress = !0;
      try {
        (await this.hass.callWS({
          type: "autodoctor/suppress",
          automation_id: t.automation_id,
          entity_id: t.entity_id,
          issue_type: t.issue_type || "unknown",
        }),
          "validation" === this._activeTab
            ? await this._fetchValidation()
            : await this._fetchConflicts());
      } catch (t) {
        console.error("Failed to suppress issue:", t);
      } finally {
        this._suppressionInProgress = !1;
      }
    }
  }
  async _clearSuppressions() {
    if (!this._suppressionInProgress) {
      this._suppressionInProgress = !0;
      try {
        ...
        console.error("Failed to clear suppressions:", t);
      } finally {
        this._suppressionInProgress = !1;
      }
    }
  }
  _renderAutomationGroup(t) {
    return q`
  ...
  _renderIssue(t) {
    const { issue: e, fix: s } = t,
      i = "error" === e.severity,
      o = this._dismissedSuggestions.has(this._getSuggestionKey(e));
    return q`
  ...
  _renderConflictsTab(t) {
    if (!this._conflictsData) return this._renderEmpty(t);
    const { conflicts: e, suppressed_count: s } = this._conflictsData,
      i = e.length > 0,
      o = e.filter((t) => "error" === t.severity).length,
      a = e.filter((t) => "warning" === t.severity).length;
    return q`
      <ha-card>
        ${this._renderHeader(t)}
        ${this._renderTabs()}
  ...
  _renderConflictsBadges(t, e, s) {
    return q`
      <div class="badges-row">
        ${
          t > 0
            ? q`<span class="badge badge-error" title="${t} conflict${1 !== t ? "s" : ""}">
              <span class="badge-icon" aria-hidden="true">✕</span>
        ...
        ${
          e > 0
            ? q`<span class="badge badge-warning" title="${e} warning${1 !== e ? "s" : ""}">
              <span class="badge-icon" aria-hidden="true">!</span>
        ...
        ${
          0 === t && 0 === e
            ? q`<span class="badge badge-healthy" title="No conflicts">
              <span class="badge-icon" aria-hidden="true">✓</span>
        ...
        ${
          s > 0
            ? q`<span class="badge badge-suppressed" title="${s} suppressed">
              <span class="badge-icon" aria-hidden="true">⊘</span>
...
((ft.CLICK_COOLDOWN_MS = 2e3),
  t([ht({ attribute: !1 })], ft.prototype, "hass", void 0),
  t([ht({ attribute: !1 })], ft.prototype, "config", void 0),
  t([pt()], ft.prototype, "_loadingValidation", void 0),
  t([pt()], ft.prototype, "_loadingConflicts", void 0),
  t([pt()], ft.prototype, "_error", void 0),
  t([pt()], ft.prototype, "_activeTab", void 0),
  t([pt()], ft.prototype, "_validationData", void 0),
  t([pt()], ft.prototype, "_conflictsData", void 0),
  t([pt()], ft.prototype, "_runningValidation", void 0),
  t([pt()], ft.prototype, "_runningConflicts", void 0),
  t([pt()], ft.prototype, "_dismissedSuggestions", void 0),
  (ft = gt = t([dt("autodoctor-card")], ft)),
...
let vt = class extends nt {
  ...
  _valueChanged(t) {
    ...
    const e = t.target,
      s = { ...this._config, [e.id]: e.value || void 0 };
...
(t([ht({ attribute: !1 })], vt.prototype, "hass", void 0),
  t([pt()], vt.prototype, "_config", void 0),
  (vt = t([dt("autodoctor-card-editor")], vt)));
var mt = Object.freeze({
  __proto__: null,
  get AutodoctorCardEditor() {
    return vt;
  },
});
export { ft as AutodoctorCard };
