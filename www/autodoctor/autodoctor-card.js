 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function pt(t){return dt({...t,state:!0,attribute:!1})}let ut=class extends at{constructor(){super(...arguments),this._data=null,this._loading=!0,this._error=null}setConfig(t){this.config=t}async firstUpdated(){await this._fetchData()}async _fetchData(){this._loading=!0,this._error=null;try{this._data=await this.hass.callWS({type:"autodoctor/issues"})}catch(t){console.error("Failed to fetch autodoctor data:",t),this._error="Failed to load automation health data"}this._loading=!1}async _refresh(){await this.hass.callWS({type:"autodoctor/refresh"}),await this._fetchData()}render(){return this._loading?W`
    ...
    `:W`
      ...
      `}_renderIssue(t){const{issue:e,fix:s,edit_url:i}=t,r="error"===e.severity;return W`
      <div class="issue ${r?"error":"warning"}">
        <div class="issue-header">
          <span class="severity-icon">${r?"✕":"!"}</span>
    ...
    `}getCardSize(){return 3}};t([dt({attribute:!1})],ut.prototype,"hass",void 0),t([dt({attribute:!1})],ut.prototype,"config",void 0),t([pt()],ut.prototype,"_data",void 0),t([pt()],ut.prototype,"_loading",void 0),t([pt()],ut.prototype,"_error",void 0),ut=t([(t=>(e,s)=>{void 0!==s?s.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)})("autodoctor-card")],ut),window.customCards=window.customCards||[],window.customCards.push({type:"autodoctor-card",name:"Autodoctor Card",description:"Shows automation health and validation issues"});export{ut as AutodoctorCard};
